...
export function Safety() {
  return (
    <section className="safety" id="safety">
      ...
      <div className="safety-grid"><p><strong>Unaudited software</strong>The protocol and interface have not undergone an independent security audit.</p><p><strong>No real deposits</strong>All balances, returns, markets, and actions shown here are simulated demo data.</p><p><strong>LP capital is at risk</strong>Fees may not offset loss from probability movement, informed flow, oracle failure, or smart-contract exploits.</p></div>
    </section>
  )
}
